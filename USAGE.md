...
| 💨 強風 (WIND) | **L15** | 環境事件：橫向力推玩家 0.4×, 動態飄移 | 只能順風修正車道 |
| 🌑 極夜 (NIGHT) | **L17** | 環境事件：除企鵝周圍 250px 圓形外全暗 | 注意視野邊緣的障礙 |
| 🌫️ 大霧 (FOG) | **L19** | 環境事件：遠處顆粒漸層遮蔽 | 障礙物遠處難辨 |
| 🌟 隱藏房間 (WARP_FLAG) | **L5+** | **0.3% 機率出現的彩虹漩渦旗** | 撞到觸發 8 秒金魚饗宴 + 時間凍結 + 無敵 + 解鎖隱藏成就 |
